...
QT_MOC_LITERAL(1, 9, 9), // "redact_me"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "data"
QT_MOC_LITERAL(4, 25, 9), // "take_info"
QT_MOC_LITERAL(5, 35, 3), // "row"
QT_MOC_LITERAL(6, 39, 3), // "col"
QT_MOC_LITERAL(7, 43, 25), // "on_searchLine_textChanged"
QT_MOC_LITERAL(8, 69, 17) // "on_create_clicked"

    },
    "Homepage\0redact_me\0\0data\0take_info\0"
    "row\0col\0on_searchLine_textChanged\0"
    "on_create_clicked"
};
...
void Homepage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->redact_me((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 1: _t->take_info((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->on_searchLine_textChanged(); break;
        ...
        {
            using _t = void (Homepage::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Homepage::redact_me)) {
                *result = 0;
                return;
            }
        }
...
void *Homepage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::mainMenu"))
        return static_cast< Ui::mainMenu*>(this);
...
// SIGNAL 0
void Homepage::redact_me(QStringList _t1)
{
