...
void todo_test::IsContained(/*QVector<QString> flags,QStringList data*/)
{
    ToDoFile be;
    QStringList data = {"Не сделано", "Нет", "Низкий", "2021-05-31T14:47:16", "test"};
...
void todo_test::sort(){
    ...
    QList<QStringList> data = {{"Не сделано", "Нет", "Низкий", "2021-05-31T14:47:16", "test"},
                               {"Не сделано", "2021-06-29T21:15:03", "Высокий", "2021-05-24T15:30:59", "тестируем редактирование"},
                               {"Сделано", "2021-05-31T14:47:16", "Высокий", "2021-05-23T15:37:55", "тестируем редактирование"}};

    QList<QStringList> sortData = {{"Не сделано", "Нет", "Низкий", "2021-05-31T14:47:16", "test"},
                                   {"Не сделано", "2021-06-29T21:15:03", "Высокий", "2021-05-24T15:30:59", "тестируем редактирование"},
                                   {"Сделано", "2021-05-31T14:47:16", "Высокий", "2021-05-23T15:37:55", "тестируем редактирование"}};
...
void todo_test::sortByDeadline(){
    ToDoFile be;
    QList<QStringList> data = {{"Status","Deadline","Priority","Created","Text"},
                               {"Не сделано", "Нет", "Низкий", "2021-05-31T14:47:16", "test"},
                               {"Не сделано", "2021-06-29T21:15:03", "Высокий", "2021-05-24T15:30:59", "тестируем редактирование"},
                               {"Сделано", "2021-05-31T14:47:16", "Высокий", "2021-05-23T15:37:55", "тестируем редактирование"}};

    QList<QStringList> sortData = {{"Status","Deadline","Priority","Created","Text"},
                                   {"Сделано", "2021-05-31T14:47:16", "Высокий", "2021-05-23T15:37:55", "тестируем редактирование"},
                                   {"Не сделано", "2021-06-29T21:15:03", "Высокий", "2021-05-24T15:30:59", "тестируем редактирование"},
                                   {"Не сделано", "Нет", "Низкий", "2021-05-31T14:47:16", "test"}};
